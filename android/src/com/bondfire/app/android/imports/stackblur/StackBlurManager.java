package com.bondfire.app.android.imports.stackblur;
 ...
 * just has to add one new block of base to the right side
 * of the stack and remove the leftmost base. The remaining
...
public class StackBlurManager {
    ...
    public Bitmap process(float radius) {
