 ...
 * Shows the various licenses required by the law
 */
public class LicenseDialogFragment extends DialogFragment {


    private static final String TAG = LicenseDialogFragment.class.getName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_license_dialog, container, false);
        }
    ...
    public static LicenseDialogFragment newInstance(int num){
