...
public abstract class BaseGameActivity extends FragmentActivity implements
        NetworkManager.GoogleSignInListener {

    // The game helper object. This class is mainly a wrapper around this object.
    protected NetworkManager mHelper;

    // We expose these constants here because we don't want users of this class
    // to have to know about GameHelper at all.
    public static final int CLIENT_GAMES = NetworkManager.CLIENT_GAMES;
    public static final int CLIENT_APPSTATE = NetworkManager.CLIENT_APPSTATE;
    public static final int CLIENT_PLUS = NetworkManager.CLIENT_PLUS;
    public static final int CLIENT_ALL = NetworkManager.CLIENT_ALL;
    ...
    public NetworkManager getGameHelper() {
        if (mHelper == null) {
            mHelper = new NetworkManager(this, mRequestedClients);
    ...
    protected void onActivityResult(int request, int response, Intent data) {
        ...
        mHelper.handleApiConnectivity(request, response, data);
    }
    ...
    protected NetworkManager.SignInFailureReason getSignInError() {
