...
public class NetworkManagerUtils {
     ...
     *                    of this resolution in handleApiConnectivity.
     ...
     *  @param activity the Activity in which the Dialog should be displayed.
     * @param requestCode the request code from handleApiConnectivity.
     * @param actResp the response code from handleApiConnectivity.
